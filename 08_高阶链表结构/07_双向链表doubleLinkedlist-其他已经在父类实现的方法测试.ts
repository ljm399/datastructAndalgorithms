...
console.log("get---------");
console.log(linked1.get(0),'linked1.get(0)');
console.log(linked1.get(1),'linked1.get(0)');
console.log(linked1.get(3),'linked1.get(0)');
linked1.traverse()

console.log("---update---");
linked1.update('caomzs',2)
linked1.update('caomzsya',0)
linked1.update('end',3)
linked1.traverse()

console.log("----indexof----");
console.log(linked1.indexof("caomzs"));
console.log(linked1.indexof("caomzsya"));
console.log(linked1.indexof("caomzsya3"));

console.log("----remove---");
console.log(linked1.remove('caoa'));
linked1.traverse()
console.log(linked1.remove('caomzs'));
linked1.traverse()

console.log("---empty----");
console.log(linked1.isempty());
linked1.traverse()
